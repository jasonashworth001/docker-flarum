...
ENV GID=991 \
    ...
    DB_PORT=3306 \
    FORUM_URL=https://forum.wikichi.org \
    FLARUM_ADMIN_USER=ashworthjg \
    FLARUM_ADMIN_PASS=pbY6HGwHje!H_AgCzgWv \
    FLARUM_ADMIN_MAIL=jason@pocketchicago.com \
    FLARUM_TITLE=WikiChi \
